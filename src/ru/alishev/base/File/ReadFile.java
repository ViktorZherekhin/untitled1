...
public class ReadFile {
    public static void main(String[] args) throws FileNotFoundException {  // это т.н. Exception, на случай
        ...
        // Есть специальный класс "ru.alishev.base.File" для работы с файлами:
...
//        for-each используется, когда надо передать все элементы массива
//        for (Тип Итерационная_переменная : Массив) { ... }
//        Тип - того же типа, что и Массив (String, int, и т.д.)
//        Итерационная_переменная - в нее будет записываться значение из Массива
//        Он говорит: "для каждого элемента массива выполнить какое-то действие"
