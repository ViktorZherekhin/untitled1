...
public class Generics {
    public static void main(String[] args) {
        ...
        animals.add("ru.alishev.base.Dog");                 // 1-й элемент
        animals.add("Bear");
        animals.add(342);
        ...
        List<Animal2> zoo3 = new ArrayList<>();      // здесь могут храниться только объекты класса "ru.alishev.base.Animal"
        zoo3.add(new Animal2(1));
        zoo3.add(new Animal2(2));
        test(zoo3);

        // Создадим еще один массив на базе класса "ru.alishev.base.Dog"
    ...
    private static void test(List<Animal2> list1){
        ...
        }                                   // у класса "Object" (родителя класса "ru.alishev.base.Animal")
    }

    public static void test2(List<? extends Animal2> list2){     // благодаря такой записи мы можем
        for (Animal2 animal : list2                             // подставлять Листы класса "ru.alishev.base.Animal2"
             ) {                                               // или любого класса-наследника "ru.alishev.base.Animal2"
            animal.eat();                                     // т.е. мы использовали "Wildcard"
        }
    }

    public static void test3(List<? super Animal2> list2) {     // благодаря такой записи мы можем
      /*  for (ru.alishev.base.Animal2 animal : list2                            // подставлять Листы класса "ru.alishev.base.Animal2"
        ) {                                                   // или любого класса выше "ru.alishev.base.Animal2"
