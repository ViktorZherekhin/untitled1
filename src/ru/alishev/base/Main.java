...
import ru.alishev.base.Forest.Tree;
...
public class Main {
    ...
    /* ЗАГЛАВНЫЕ - строчные */
        ...
        Tree tree1 = new Tree();    // создали новый объект класса "Tree" из пакета "ru.alishev.base.Forest"
                                    // при это в самом верху появилась запись "import ru.alishev.base.Forest.Tree;"
